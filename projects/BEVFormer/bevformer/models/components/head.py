...
class BEVFormerHead(DETRHead):
    ...
    def get_targets(self, batch_cls_scores: List[Tensor], batch_bbox_preds: List[Tensor],
                    batch_gt_instances_3d: InstanceList, **kwargs) -> tuple():
    ...
    def loss_by_feat_single(self, batch_cls_scores: Tensor, batch_bbox_preds: Tensor,
                            batch_gt_instances_3d: InstanceList, **kwargs) -> Tuple[Tensor, Tensor]:
        ...
        cls_reg_targets = self.get_targets(cls_scores_list, bbox_preds_list, batch_gt_instances_3d)
    ...
    def loss_by_feat(self, batch_gt_instances_3d: InstanceList, preds_dicts: Dict[str, Tensor],
                     batch_gt_instances_3d_ignore: OptInstanceList = None, **kwargs) -> Dict:
        ...
        if enc_cls_scores is not None:
            enc_loss_cls, enc_losses_bbox = self.loss_by_feat_single(enc_cls_scores, enc_bbox_preds,
                                                                     batch_gt_instances_3d_list)
