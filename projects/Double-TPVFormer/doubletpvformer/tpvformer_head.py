...
class TPVFormerDecoder(BaseModule):
    ...
    def predict_h(self, tpv_list_h, tpv_list, batch_data_samples, miu=0.25):
        """
        tpv_list[0]: bs, h*w, c
        tpv_list[1]: bs, z*h, c
        tpv_list[2]: bs, w*z, c
        ...
        for i, data_sample in enumerate(batch_data_samples):
            ...
            fused_pts_high = tpv_hw_pts_h + tpv_zh_pts_h + tpv_wz_pts_h
            fused_pts_low = tpv_hw_pts[..., :len_high] + tpv_zh_pts[..., :len_high] + tpv_wz_pts[..., :len_high]
            fused_pts = miu * fused_pts_low + (1 - miu) * fused_pts_high
